...
public void OnPluginStart()
{
	...
	HookEvent("round_start", Event_RoundStart, EventHookMode_PostNoCopy);                  // When a new round starts (2 rounds in 1 map -- this should be called twice a map)
...
Action Timer_PluginStart(Handle timer)
{
	...
	CreateTimer(2.0, GetBossPercents);
	UpdateReadyUpFooter(2.5);
