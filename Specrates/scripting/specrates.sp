...
public void OnPluginStart()
{
	...
	g_cAdminFlag = AutoExecConfig_CreateConVar("sm_specrates_admin_flag", "", "Admin flag required to not have specrates locked at 30. Leave empty to cap all players.", FCVAR_NONE);
