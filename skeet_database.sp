...
public Plugin myinfo =
{
	...
	author = "thrillkill, JNC, Harry, heize",
...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_top5skeets", Command_Top, "Show TOP 5 players in statistics.", 0);
...
void PrintTopSkeeters(int client)
{
	...
	if (oneshot == 1)
	{
		if(g_hCvar1v1Separate.BoolValue && Is1v1)
			...
			FormatEx(sBuffer, sizeof(sBuffer), "Top 5 Heizemod Skeeters");
	}
	else
	{
		if(g_hCvar1v1Separate.BoolValue && Is1v1)
			...
			FormatEx(sBuffer, sizeof(sBuffer), "Top 5 Heizemod Skeeters", TOP_NUMBER);
	}
	...
	if (totalskeets)
	{
		...
		panel.DrawText("\n ");
		FormatEx(sBuffer, sizeof(sBuffer), "Total of %d skeets on Heizemod%s", totalskeets, (g_hCvar1v1Separate.BoolValue && Is1v1) ? " in 1v1." : ".");
